...
class TokenPayQrCodeController extends PayController
{
    public function gateway(string $payway, string $orderSN)
    {
        try {
            ...
            $parameter = [
                ...
                'RedirectUrl' => route('tokenpay-qr-return', ['order_id' => $this->order->order_sn]),
    ...
    public function notifyUrl(Request $request)
    {
        ...
        if($payGateway->pay_handleroute != 'pay/tokenpay-qr'){
            return 'fail';
        }
        //合法的数据
