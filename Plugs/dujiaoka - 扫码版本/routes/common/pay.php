...
Route::group(['prefix' => 'pay', 'namespace' => 'Pay', 'middleware' => ['dujiaoka.pay_gate_way']], function () {
    ...
    // tokenpay - 扫码版本
    Route::get('tokenpay-qr/{payway}/{orderSN}', 'TokenPayQrCodeController@gateway');
    Route::post('tokenpay-qr/notify_url', 'TokenPayQrCodeController@notifyUrl');
    Route::get('tokenpay-qr/return_url', 'TokenPayQrCodeController@returnUrl')->name('tokenpay-qr-return');
